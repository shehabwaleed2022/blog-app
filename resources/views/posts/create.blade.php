<x-layout :pageTitle="$pageTitle">
    <section class="px-6 py-8"> 
      ...
      <div class="container mx-auto max-w-sm px-4 py-8">
        ...
        <form method="POST" action="/admin/posts/create" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          @csrf
          <div class="mb-4">
          ...
          <div class="mb-6">
            ...
            <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              id="post-body" name="body" placeholder="Enter the body of your post"></textarea>
            @error('body')
              <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
            @enderror
          </div>
